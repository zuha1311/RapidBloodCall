...
public class DirectionParser1 {
    private static final String TAG = DirectionParser1.class.getName();
    ...
    public DirectionParser1(Context context, MapViewLite mapView) {
